...
double absLowerB[10000];
double absUpperB[10000];
int absFlag[10000];
...
public:
	...
	/* if(absFlag[tighteningVarIndex]>0) { */
	/*     printf("max is %.5f, absupperb is %.5f\n", max, absUpperB[tighteningVarIndex]); */
	/*     printf("min is %.5f, ablowerb is %.5f\n", min, absLowerB[tighteningVarIndex]); */
	/*     max = std::min(max,absUpperB[tighteningVarIndex]); */
	/*     min = std::max(min,absLowerB[tighteningVarIndex]); */
	/* } */

	/* if(absFlag[tighteningVarIndex] == 2 ) { */
	/*     printf("max is %.5f, absupperb is %.5f\n", max, absUpperB[tighteningVarIndex]); */
	/*     printf("min is %.5f, ablowerb is %.5f\n", min, absLowerB[tighteningVarIndex]); */
	/*     if(absUpperB[tighteningVarIndex] > 0) */
	/* 	max = std::min(max,absUpperB[tighteningVarIndex]); */
	/*     min = std::max(min,absLowerB[tighteningVarIndex]); */
	/* } */
